...
### 矽晶圓/上游材料
環球晶(6488), 中美晶(5483), 台勝科(3532), 合晶(6182)

### IC 設計
聯發科(2454), 聯詠(3034), 瑞昱(2379), 譜瑞-KY(4966), 創意(3443), 世芯-KY(3661), 智原(3035)
...
### 光通訊/CPO/矽光子
聯亞(3081), 聯鈞(3450), 華星光(4979), 上詮(3363), 波若威(3163), 眾達-KY(4977),
光聖(6442), 台表科(6278), 訊芯-KY(6451)

### CCL 銅箔基板
台光電(2383), 台燿(6274), 聯茂(6213)

### PCB/ABF 載板
欣興(3037), 南電(8046), 景碩(3189), 金像電(2368), 臻鼎-KY(4958), 華通(2313)

### 被動元件
國巨(2327), 華新科(2492), 奇力新(2456), 禾伸堂(3026), 凱美(2375), 大毅(2478), 立隆電(2472)

### 散熱
雙鴻(3324), 奇鋐(3017), 建準(2421), 力致(3444), 高力(8996), 健策(3653)
...
### 重電/電網
華城(1519), 中興電(1513), 士電(1503), 亞力(1514), 大同(2371)

### FOPLP 面板級封裝
群創(3481), 友達(2409)

### 低軌衛星
昇達科(3491), 華通(2313), 兆赫(2485), 啟碁(6285), 同欣電(6271), 台揚(2314)
...
### 機器人/自動化
上銀(2049), 所羅門(2359), 盟立(2464), 亞德客-KY(1590), 和大(1536)

### 先進封裝設備（CoWoS）
萬潤(6187), 弘塑(3131), 帆宣(6196), 辛耘(3583), 均華(6640), 志聖(2467)

### 玻璃基板/TGV
欣興(3037), 群創(3481), 威剛(3260)
題材聯想(低信心): 富喬(1815), 宸鴻TPK(3673)

### ASIC 設計服務
世芯-KY(3661), 創意(3443), 智原(3035), 聯發科(2454)

### 矽智財/IP
力旺(3529), M31(6643), 智原(3035), 創意(3443)
